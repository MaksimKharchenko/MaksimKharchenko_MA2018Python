...
def draw(canvas):
    ...
    if in_play is True:
        canvas.draw_image(card_back, CARD_BACK_CENTER, CARD_BACK_SIZE,
                          ...
                          CARD_SIZE)
    canvas.draw_text(outcome, [50, 350], 20, "Black")
    canvas.draw_text("Dealer wins: "+str(dealer_score), [50, 130], 20, "Black")
    canvas.draw_text("Player wins: "+str(player_score), [50, 430], 20, "Black")
    canvas.draw_text("BlackJack", [230, 60], 20, "Black")
